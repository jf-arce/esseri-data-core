...
# Importa el models.py de cada módulo para que sus tablas queden
...
# La URL de conexión se toma de src.config.settings (que a su vez lee .env),
# no del alembic.ini, para no duplicar la configuración.
